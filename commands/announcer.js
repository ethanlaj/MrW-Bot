module.exports.run = async (bot, message, args, prefix, content) => {
	...
	if (announcermsg) {
		...
		let togglesetting = settings.split("|")[1].trim() || "false";
		let channelsetting = settings.split("|")[2].trim() || "none";
		let avatarsetting = settings.split("|")[3].trim() || "false";
		let footersetting = settings.split("|")[4].trim() || "false";
		let hellomsg = settings.split("|")[5].trim() || "none";
		let byemsg = settings.split("|")[6].trim() || "none";
		//execute if msg
